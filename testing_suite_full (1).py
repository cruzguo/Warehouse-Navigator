...
def run_all( fout ):
    ...
    partA_weight = 50 # 50% of total
    partB_weight = 50 # 50% of total
    partC_weight = 0 # 0% of total
    totalScore = 0.0

    scores = []
    weights = [partA_weight, partB_weight, partC_weight]
    test_cases = [PartATestCase, PartBTestCase, PartCTestCase]
    parts = ['A', 'B', 'C']
    ...
    for part_name, test_cases, weight in zip(parts, test_cases, weights):
